...
$--font-path: '~@antares_boy/t-ui/lib/theme-chalk/fonts';

@import "~@antares_boy/t-ui/packages/theme-chalk/src/index";
```
...
import ElementUI from '@antares_boy/t-ui'
import Vue from 'vue'
