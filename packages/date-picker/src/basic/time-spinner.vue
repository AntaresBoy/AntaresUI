...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from '@antares_boy/t-ui/src/utils/date-util';
  import ElScrollbar from '@antares_boy/t-ui/packages/scrollbar';
  import RepeatClick from '@antares_boy/t-ui/src/directives/repeat-click';
