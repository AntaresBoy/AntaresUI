<script>
  ...
  import ElButton from '@antares_boy/t-ui/packages/button';
  import ElButtonGroup from '@antares_boy/t-ui/packages/button-group';
  import { generateId } from '@antares_boy/t-ui/src/utils/util';
